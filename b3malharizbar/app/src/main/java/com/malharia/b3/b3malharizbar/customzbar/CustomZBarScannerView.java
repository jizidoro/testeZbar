...
package com.malharia.b3.b3malharizbar.customzbar;
...
import com.core.src.main.java.me.dm7.barcodescanner.core.BarcodeScannerView;
...
public class CustomZBarScannerView extends BarcodeScannerView {
    private static final String TAG = "CustomZBarScannerView";
    private ImageScanner mScanner;
    private List<me.dm7.barcodescanner.zbar.BarcodeFormat> mFormats;
    private CustomZBarScannerView.ResultHandler mResultHandler;

    public CustomZBarScannerView(Context context) {
        super(context);
        this.setupScanner();
    }
    ...
    public void setResultHandler(CustomZBarScannerView.ResultHandler resultHandler) {
            ...
            try {
                ...
                if (result != 0) {
                    ...
                    handler.post(new Runnable() {
                        public void run() {
                            CustomZBarScannerView.ResultHandler tmpResultHandler = CustomZBarScannerView.this.mResultHandler;
                            CustomZBarScannerView.this.mResultHandler = null;
                            CustomZBarScannerView.this.stopCameraPreview();
                ...
                Log.e("CustomZBarScannerView", var15.toString(), var15);
            }

        }
    }

    public void resumeCameraPreview(CustomZBarScannerView.ResultHandler resultHandler) {
        this.mResultHandler = resultHandler;
